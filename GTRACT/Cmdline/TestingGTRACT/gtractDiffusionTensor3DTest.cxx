...
int main( int argc, char *argv[] )
{
  ...
  for( actualTensorIt.GoToBegin(); !actualTensorIt.IsAtEnd(); ++actualTensorIt )
  {
    ...
    if( actualTensorIndex[ 0 ] == 31 && actualTensorIndex[ 1 ] == 1 && actualTensorIndex[ 2 ] == 0 )
    {
      // Test trace or ADC
      float testADC = 0.0;
      testADC = static_cast< float >( tensorPixel.GetTrace() / 3.0 );
      std::cout << "testADC: " << testADC << std::endl;
      if( tensorPixel.GetTrace() != 0.00130511 && testADC != 0.000435037 )
      {
        return EXIT_SUCCESS;
      }
      else
  ...
  for( simpleSyntheticTensorIt.GoToBegin(); !simpleSyntheticTensorIt.IsAtEnd(); ++simpleSyntheticTensorIt )
  {
    ...
    // Test trace and ADC
    float testADC = 0.0;
    testADC = static_cast< float >( simpleSyntheticTensorPixel.GetTrace() / 3.0 );
    std::cout << "testADC: " << testADC << std::endl;
    if( simpleSyntheticTensorPixel.GetTrace() != 0.001900000 && testADC != 0.000633333 )
    {
      return EXIT_SUCCESS;
    }
    else
  ...
  for( compSyntheticTensorIt.GoToBegin(); !compSyntheticTensorIt.IsAtEnd(); ++compSyntheticTensorIt )
  {
    ...
    compSyntheticTensorPixel[ 1 ] = 0.0001;
    compSyntheticTensorPixel[ 2 ] = 0.0002;
    compSyntheticTensorPixel[ 3 ] = 0.0007;
    compSyntheticTensorPixel[ 4 ] = 0.0003;
  ...
  for( compSyntheticTensorIt.GoToBegin(); !compSyntheticTensorIt.IsAtEnd(); ++compSyntheticTensorIt )
  {
    ...
    // Test trace and ADC
    float testADC = 0.0;
    testADC = static_cast< float >( compSyntheticTensorPixel.GetTrace() / 3.0 );
    std::cout << "testADC: " << testADC << std::endl;
    if( compSyntheticTensorPixel.GetTrace() != 0.001900000 && testADC != 0.000633333 )
    {
      return EXIT_SUCCESS;
    }
    else
